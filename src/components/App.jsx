        ...
        return  <React.Fragment>
                    ...
                    <div className='main-container'>
                        <div className='product-container'>
                            ...
                            <Product onAdd={() => this.addItem(1, 'Äpfel', 4.90)} image="apples.jpg" title="Äpfel" description="Pink Lady Äpfel aus Chile. Sie sind sehr süß, saftig und aromatisch im Geschmack."/>
